...
class UserController extends Controller
{
    ...
    public function cbd(Request $request)
    {
        return view('home.cbd');
    }

    public function p_mgt(Request $request)
    {
        return view('home.p_mgt');
    }
    ...
    public function oilandgas(Request $request)
    {
        return view('home.oilandgas');
    }
    ...
    public function dashboard(Request $request)
    {
        if ($request->method() == "GET") {
            ...
            return view("customer.index", ["account" => $userAccount, "nfp" => $nfp, "deposits" => $deposits, "allLoans" => $allLoans, "investments" => $investments, "withdrawals" => $withdrawals, "loans" => $loans, "charities" => $charities, "childrenAccount" => $childrenAccount, "retirement" => $retirement]);
        }
    }

    public function retirementCustomer(Request $request, $name, $id = null)
    {
        if ($request->method() == "GET") {
            $user = $request->user();
