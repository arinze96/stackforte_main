            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Loans</h4>
                                <form class="" method="POST" data-post-type="edit-plan"
                                    ...
                                    <div class="col-sm-6 col-md-12 mb-2">
                                        <div class="form-group">
                                            <label class="form-label" for="min">Edit Loan amount
                                                {{-- Amount ({{ $loans->currency }}) --}}
                                                {{-- Amount ({{ dd($loans->amount) }}) --}}
                                              </label>
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <button type="submit" name="edit-plan" style="text-align:center;"
                                                    class="d-block form-control btn btn-primary ">Edit Loan </button>
                                            </div>
                                        </div>
                                    </div>
