                            ...
                            <form class="" method="POST" data-post-type="edit-plan"
                                ...
                                <div class="col-sm-6 col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input style="color: white"  required="" type="text" name="name" style="color: white" class="form-control"
                                ...
                                <div class="col-sm-6 col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input style="color: white"  required="" type="text" name="min" class="form-control"
                                ...
                                <div class="col-sm-6 col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input style="color: white"  required="" type="text" name="max" class="form-control"
                                ...
                                <div class="col-sm-6 col-md-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input style="color: white"  required="" type="text" name="roi" class="form-control"
                                ...
                                <div class="col-sm-6 col-md-12 mb-2">
                                    <div class="form-group">
                                        <label class="form-label" for="duration">Duration in days (example 30
                                            days)</label>
                                        <div class="form-control-wrap">
                                            <input style="color: white"  required="" type="text" name="duration"
                                ...
                                <div class="col-sm-6 col-md-12 mb-2">
                                    <div class="form-group">
                                        <label class="form-label" for="commission">Total Commission in percent (%)
                                            (example : 60)</label>
                                        <div class="form-control-wrap">
                                            <input style="color: white"  required="" type="text" name="commission"
