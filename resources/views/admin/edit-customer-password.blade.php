                                ...
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <div class="nk-block-head-content">
                                            <div class="nk-block-head-sub"><a class="back-to" href="javascript:void(0)"
                                                    onclick="history.go(-1)"><em
                                        ...
                                        <div class="card card-bordered card-preview">
                                            <div class="card-inner">
                                                <div class="preview-block">
                                                    ...
                                                    <div class="">
                                                        <form class="newForm" data-post-type="change-password"
                                                            action="http://localhost/ghost_project/admin/customer">
                                                            ...
                                                            <div class="col-sm-4 mt-3">
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap">
                                                                        <button type="submit"
                                                                            data-value="Change Password"
                                                                            name="password-change"
                                                                            style="text-align:center;"
                                                                            class="d-block form-control btn btn-primary "
                                                                            id="password-change">Change
                                                                            Password</button>
                                                                    </div>
                                                                </div>
                                                            </div>
